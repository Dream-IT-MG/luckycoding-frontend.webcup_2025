  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content:
        "Comment vous sentez-vous après avoir créé votre page d'adieu ? C'est parfois un grand pas de dire au revoir, que ce soit à un travail, une relation ou un lieu... Je suis là pour vous écouter.",
    },
  ]);
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          role: "assistant",
          content:
            "Désolé, j'ai rencontré un problème de communication. Veuillez réessayer.",
        },
      ]);
    } finally {
      setIsLoading(false);
