...
export default function AssistancePage() {
  ...
  // defile vers le bas à chaque nouveau mesg
  useEffect(() => {
    scrollToBottom();
  }, [messages]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Préparer historique msg pour l'API
  ...
  return (
    ...
    >
      ...
      {/* Section droite avec le chatbot */}
      <div className="relative z-10 w-2/3 flex flex-col p-8 text-white">
        <h1 className="text-3xl font-bold mb-6">Espace de dialogue</h1>
        
        {/* Historique des messages */}
        <div className="flex-grow overflow-auto mb-4 rounded-lg bg-gray-800 bg-opacity-40 p-4" style={{ maxHeight: "70vh" }}>
          <div className="flex flex-col space-y-4">
            ...
            {isLoading && (
              <div className="flex justify-start">
                <div className="max-w-3/4 rounded-lg p-3 bg-gray-700 text-white">
